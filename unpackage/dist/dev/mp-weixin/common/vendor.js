...
function initRuntimeSocketService() {
  const hosts = "192.168.115.165,127.0.0.1";
  const port = "8090";
  const id = "mp-weixin_03zspN";
...
const b = true, E = "mp-weixin", P = T(define_process_env_UNI_SECURE_NETWORK_CONFIG_default), C = E, A = T('{"address":["127.0.0.1","192.168.115.165"],"servePort":7000,"debugPort":9000,"initialLaunchType":"local","skipFiles":["<node_internals>/**","D:/Program Files/HBuilderX/plugins/unicloud/**/*.js"]}'), O = T('[{"provider":"aliyun","spaceName":"budpapaer","spaceId":"mp-45be7326-2629-4d05-ae43-15707ed3f53a","clientSecret":"F5LS9ziSE8cDPCc8mYa5Bw==","endpoint":"https://api.next.bspapp.com"}]') || [];
let N = "";
try {
  N = "__UNI__F0F1051";
} catch (e2) {
